...
// ==================================================================================================
// Audit énergétique v2.3 - TypeScript definitions
// Source : audit_v2.3.xsd
// ==================================================================================================
...
export const Administratif = z.object({
	...
	enum_version_dpe_id: enums.VersionDpeEnum.exclude(["2.6"])
		.nullable()
		.optional(),
	enum_version_audit_id: enums.VersionAuditEnum.exclude(["2.5"]),
...
export const PlancherHaut = z.object({
	donnee_entree: z.object({
		...
		paroi_lourde: z.boolean().nullable().optional(),
