...
// ==================================================================================================
// Audit énergétique v2.2 - TypeScript definitions
// Source : audit_v2.2.xsd (identique à audit_v2.1.xsd — aucune évolution structurelle)
// ==================================================================================================
...
export const Administratif = z.object({
	...
	enum_version_dpe_id: enums.VersionDpeEnum.exclude(["2.5", "2.6"])
		.nullable()
		.optional(),
	enum_version_audit_id: enums.VersionAuditEnum.exclude(["2.3", "2.4", "2.5"]),
	...
	consentement_proprietaire: z.boolean().nullable().optional(),
});
