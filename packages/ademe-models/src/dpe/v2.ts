...
export const PackTravaux = z.object({
	...
	travaux_collection: z.array(Travaux).default([]),
});
...
export const DescriptifSimplifie = z.object({
	...
	enum_categorie_descriptif_simplifie_id:
		enums.CategorieDescriptifSimplifieEnum,
});
...
export const GenerateurChauffage = z.object({
	donnee_entree: z.object({
		...
		Enumentifiant_reseau_chaleur: z.string().nullable().optional(),
		...
		enum_lien_generateur_emetteur_id:
			enums.LienGenerateurEmetteurEnum.nullable().optional(),
	}),
...
export const EmetteurChauffage = z.object({
	donnee_entree: z.object({
		...
		enum_equipement_intermittence_id:
			enums.EquipementIntermittenceEnum.nullable().optional(),
		...
		enum_temp_distribution_ch_id:
			enums.TempDistributionChEnum.nullable().optional(),
		enum_lien_generateur_emetteur_id:
			enums.LienGenerateurEmetteurEnum.nullable().optional(),
	}),
	donnee_intermediaire: z.object({
...
export const InstallationChauffage = z.object({
	donnee_entree: z.object({
		...
		enum_methode_saisie_fact_couv_sol_id:
			enums.MethodeSaisieFactCouvSolEnum.nullable().optional(),
...
export const InstallationEcs = z.object({
	donnee_entree: z.object({
		...
		enum_type_installation_solaire_id:
			enums.TypeInstallationSolaireEnum.nullable().optional(),
		tv_rendement_distribution_ecs_id: z.number().nullable().optional(),
		enum_bouclage_reseau_ecs_id:
			enums.BouclageReseauEcsEnum.nullable().optional(),
		reseau_distribution_isole: z.boolean().nullable().optional(),
	}),
	donnee_intermediaire: z.object({
		rendement_distribution: z.number(),
...
export const PontThermique = z.object({
	donnee_entree: z.object({
		...
		pourcentage_valeur_pont_thermique: z.number().nullable().optional(),
		l: z.number(),
...
export const Porte = z.object({
	donnee_entree: z.object({
		...
		enum_type_pose_id: enums.TypePoseEnum.nullable().optional(),
	}),
	donnee_intermediaire: z.object({
		uporte: z.number(),
...
export const Mur = z.object({
	donnee_entree: z.object({
		...
		enum_materiaux_structure_mur_id:
			enums.MateriauxStructureMurEnum.nullable().optional(),
		enum_methode_saisie_u0_id: enums.MethodeSaisieU0Enum,
