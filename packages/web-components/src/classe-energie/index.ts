...
import { ETIQUETTE_ENERGIE_COLORS as COLORS } from "../shared/colors.js";
import "../icon-etiquette/index.js";

const ICON_COLOR = "white";

export class ClasseEnergie extends BaseComponent {
	...
	protected render() {
		...
		if (!value) {
			console.warn("ClasseEnergie: 'value' attribute is required.");
			return;
		}
		if (!Object.keys(COLORS).includes(value)) {
			console.warn(`ClasseEnergie: unknown value "${value}".`);
			return;
		}
...
define("classe-energie", ClasseEnergie);
