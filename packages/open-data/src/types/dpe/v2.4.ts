...
// ==================================================================================================
// DPEv2.4 - TypeScript definitions
// Source : DPEv2.4.xsd
// ==================================================================================================
...
export type CaracteristiqueGenerale = {
	...
	appartement_non_visite?: boolean | null;
};
...
export type Administratif = {
	...
	enum_version_id: enums.VersionEnum;
	...
	consentement_proprietaire?: boolean | null;
	information_consentement_proprietaire?: InformationConsentementProprietaire | null;
	enum_consentement_formulaire_id?: enums.ConsentementFormulaireEnum | null;
	information_formulaire_consentement?: InformationFormulaireConsentement | null;
	enum_commanditaire_id?: enums.CommanditaireEnum | null;
};
...
export type InstallationEcs = {
	donnee_entree: {
		...
		reseau_distribution_isole?: boolean | null;
	};
	donnee_intermediaire: {
...
export type GenerateurEcs = {
	donnee_entree: {
		...
		position_volume_chauffe?: boolean | null;
		position_volume_chauffe_stockage?: boolean | null;
...
export type MurNeuf = {
	donnee_entree: {
		...
		epaisseur_structure?: number | null;
		enum_materiaux_structure_mur_id?: enums.MateriauxStructureMurEnum | null;
		enduit_isolant_paroi_ancienne?: boolean | null;
		enum_type_doublage_id?: enums.TypeDoublageEnum | null;
		enum_type_isolation_id: enums.TypeIsolationEnum;
		resistance_isolation?: number | null;
		epaisseur_isolation?: number | null;
...
export type BaieVitreeNeuf = {
	donnee_entree: {
		...
		enum_type_baie_id: enums.TypeBaieEnum;
		enum_type_fermeture_id: enums.TypeFermetureEnum;
		presence_protection_solaire_hors_fermeture?: boolean | null;
		presence_retour_isolation?: boolean | null;
