...
export function calcule_u0_doublage(props: {
	...
	switch (props.type_doublage) {
		case models.enveloppe.mur.TypeDoublage.enum.sans_doublage:
			return 0;
		case models.enveloppe.mur.TypeDoublage.enum.indetermine:
			return 10;
		case models.enveloppe.mur.TypeDoublage.enum.lame_air_inferieur_15mm:
			return 10;
		case models.enveloppe.mur.TypeDoublage.enum.lame_air_superieur_15mm:
			return 21;
		case models.enveloppe.mur.TypeDoublage.enum.materiaux_connu:
			return 21;
		default:
			return 0;
	}
