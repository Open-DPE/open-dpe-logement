...
export function mapBaie(props: {
	...
	if (!enveloppe.localNonChauffe.baie.isPosition(position))
		throw new Error(
			`La position de la baie ne peut être déterminée pour : ${JSON.stringify(props.baie)}`,
		);
	...
	if (!enveloppe.localNonChauffe.baie.isBaie(value))
		throw new Error(
			`La baie ne peut être déterminée pour : ${JSON.stringify(props.baie)}`,
		);
...
export function mapTypeVitrage(
	...
	switch (props.donnee_entree.tv_coef_transparence_ets_id) {
		...
		case 13:
		case 18:
			return TypeVitrageEnum.double_vitrage;

		case 4:
		case 9:
		case 14:
		case 19:
			return TypeVitrageEnum.double_vitrage_fe;

		case 5:
		case 10:
		case 15:
		case 20:
			return TypeVitrageEnum.triple_vitrage;

		case 6:
		case 11:
		case 16:
		case 21:
			return TypeVitrageEnum.triple_vitrage_fe;
