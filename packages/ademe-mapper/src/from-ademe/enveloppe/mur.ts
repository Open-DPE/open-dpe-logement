...
const MateriauMurEnum = enveloppe.mur.MateriauMurEnum;
const TypeDoublageEnum = enveloppe.mur.TypeDoublageEnum;
...
export function mapPresenceEnduitIsolant(
	...
	return "enduit_isolant_paroi_ancienne" in props.donnee_entree
		? mapBoolean(props.donnee_entree.enduit_isolant_paroi_ancienne)
		: null;
}
